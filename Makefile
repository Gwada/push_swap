...
#    Updated: 2018/04/12 20:38:15 by dlavaury         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
gops3:
	...
	@make $(PUSH_SWAP)
#	@time ./push_swap $(NUM3)
	./push_swap $(NUM3) | ./visualizer $(NUM3)
...
gops4:
	...
	@make $(PUSH_SWAP)
#	@time ./push_swap $(NUM3)
	./push_swap $(NUM4) | ./visualizer $(NUM4)
...
gops5:
	...
	@make $(PUSH_SWAP)
#	@time ./push_swap $(NUM3)
	./push_swap $(NUM5) | ./visualizer $(NUM5)
